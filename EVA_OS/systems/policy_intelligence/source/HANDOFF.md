...
- Government policy system remains scoped to policy original-source crawling, policy evidence chains, policy PDF reports, source/platform authority readiness, and platform authorization readiness. It should not own industry daily reports, QuantLab backtests, or consumer-analysis workflows.
