...
This directory is the EVA_OS landing zone for the AI-Research-System / Industry Research and Trading Strategy Advice system.
...
- `source/src/`: research, reporting, monitoring, data trust, reconciliation, ResearchBus, QuantLab, policy bridge, moomoo/OpenD adapter, and report-quality logic.
...
1. Create an EVA_OS adapter that publishes report readiness, evidence-grade summaries, research themes, and validation tasks to ResearchBus without exposing raw account artifacts.
...
3. Move macOS operation into the unified EVA_OS UI Shell after the policy system is migrated.
