...
run_step "QuantLab chat dropbox" scripts/researchBusApi.sh process-dropbox --min-age-seconds 0 --limit 100 --json
run_step "QuantLab heartbeat" scripts/researchBusApi.sh heartbeat \
...
run_step "QuantLab request processing" scripts/researchBusApi.sh process --system-name ResearchBus --limit 100 --json
run_step "QuantLab child system registry" scripts/orchestrateSystems.sh register --json
run_step "QuantLab child system artifacts" scripts/orchestrateSystems.sh sync-artifacts --json
run_step "QuantLab research bus sync" scripts/syncResearchBus.sh --json
