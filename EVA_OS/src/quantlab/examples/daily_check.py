...
from quantlab.system import build_daily_readiness, write_daily_readiness


def main() -> None:
    parser = argparse.ArgumentParser(description="Run a read-only QuantLab daily readiness check.")
    ...
    if args.json:
        ...
        return
    print(f"QUANTLAB_DAILY_READINESS: {payload['readiness_status']} {payload['as_of']}")
