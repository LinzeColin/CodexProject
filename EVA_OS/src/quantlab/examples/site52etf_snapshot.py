...
def main() -> None:
    parser = argparse.ArgumentParser(description="Refresh the EVA_OS 52ETF public read-only market-cloud snapshot.")
    ...
    parser.add_argument("--json", action="store_true", help="Print EVAOS52ETFPublicSnapshotV1 as JSON.")
    ...
    if payload.get("outputs"):
        print(f"EVA_OS_52ETF_PUBLIC_SNAPSHOT_OUTPUTS: {payload['outputs']}")
