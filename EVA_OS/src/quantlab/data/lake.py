...
from quantlab.config import CACHE_DATA_DIR, PROJECT_ROOT
from quantlab.data.market_events import MARKET_EVENT_LOG_SCHEMA, MARKET_EVENT_SCHEMA, read_market_events_jsonl
from quantlab.data.models import REQUIRED_BAR_COLUMNS
from quantlab.storage import atomic_write_json, atomic_write_text


DATA_LAKE_MANIFEST_SCHEMA = "EVAOSReproducibleDataLakeManifestV1"
DATA_LAKE_REPLAY_CURSOR_SCHEMA = "EVAOSDataLakeReplayCursorV1"
ASSET_COLUMNS = [
    "asset_id",
    "dataset",
    "asset_type",
