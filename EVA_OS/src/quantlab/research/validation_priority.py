...
from quantlab.storage import atomic_write_json, atomic_write_text, read_json_state
...
def _infer_gap(record: dict[str, Any]) -> str:
    ...
    if "quantlabreportevidencev1" in text or "报告证据" in text:
...
def _verification_method(gap: str) -> str:
    return {
        ...
        "ReportEvidence": "Regenerate report with QuantLabReportEvidenceV1 and linked RunMetadata.",
