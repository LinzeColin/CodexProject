...
def quick_actions() -> list[QuickAction]:
    return [
        QuickAction(
            ...
            "先看 EVA_OS 是否可继续研究：就绪检查、集成审计、业务子系统、最新报告和行动队列。",
            "Check whether EVA_OS is ready for research: readiness, integration audit, business subsystems, latest report, and action queue.",
            "总控驾驶舱",
            "Executive Command Center",
            "command",
        ),
