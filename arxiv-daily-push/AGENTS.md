...
- Every implementation closeout must state the current V7.1 Task ID and any
  legacy alias. Current development entry is `S2PCT04` (`S2P2T04` legacy alias)
  top-journal Profile、发表关系、更正撤回 metadata-only no-send shadow evidence.
  `S2PCT03` (`S2P2T03` legacy alias) The Lancet/top-journal medical
...
- Legacy `S2P2T04` maps to V7.1 `S2PCT04`; legacy `S2P2T03` maps to V7.1
