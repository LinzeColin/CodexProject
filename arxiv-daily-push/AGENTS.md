...
- Every implementation closeout must state the current V7.1 Task ID and any
  legacy alias. Current development entry is `S2PDT04` / legacy `S2P3T04`
  China official D3 source-domain readiness review.
  `S2PDT03` / legacy `S2P3T03` China legal metadata, effectivity/version, and
  reprint relation shadow, `S2PDT02` / legacy `S2P3T02` China C1 central department source map and
  `S2PDT01` / legacy `S2P3T01` China C0 national authoritative backbone are
  completed metadata-only no-production evidence. `S2PCT07` D2 source-domain
  ...
  foundation are completed D2 shadow records, not D2 source-domain acceptance
  claims. `S2PBT01`
...
- Legacy `S2P3T04` maps to V7.1 `S2PDT04`; legacy `S2P3T03` maps to V7.1
  `S2PDT03`; legacy `S2P3T02` maps to V7.1 `S2PDT02`; legacy `S2P3T01` maps to V7.1 `S2PDT01`. Legacy `S2P2T04` maps to V7.1
