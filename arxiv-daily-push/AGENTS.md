...
- Every implementation closeout must state the current V7.1 Task ID and any
  legacy alias. Current development entry is `S2PDT03` / legacy `S2P3T03`
  China legal metadata, effectivity/version, and reprint relation shadow.
  `S2PDT02` / legacy `S2P3T02` China C1 central department source map and
...
- Legacy `S2P3T03` maps to V7.1 `S2PDT03`; legacy `S2P3T02` maps to V7.1
  `S2PDT02`; legacy `S2P3T01` maps to V7.1 `S2PDT01`. Legacy `S2P2T04` maps to V7.1
