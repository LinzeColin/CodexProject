...
| S2PDT02 | S2PD | planned | ACC-S2PDT02-C1 | Next V7.1 China C1 central department and key ministry source map; no D3 source-domain acceptance, SMTP, Release, scheduler, PDF/full-text download, paid API use, or bulk scraping is allowed | `docs/pursuing_goal/v7_1/ROADMAP/roadmap_v7.yaml` |
