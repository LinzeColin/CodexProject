...
| S2PCT05 | S2PC | completed | ACC-S2PCT05-ENGINEERING-SIGNALS | V7.1 engineering open-source, code, benchmark, model-card, release, and standards public-signal metadata-only no-send shadow evidence passed focused tests and CLI fixture canary; no D2 source-domain acceptance or integrated production acceptance is claimed | `docs/phase_records/PHASE_S2PCT05_ENGINEERING_SIGNALS_EVIDENCE.md`; `governance/run_manifests/ADP-S2PCT05-ENGINEERING-SIGNALS-EVIDENCE-20260624.json` |
| S2PCT06 | S2PC | completed | ACC-S2PCT06-REPORTS | V7.1 authoritative research institution and industry technical report metadata-only no-send shadow evidence passed focused tests; no D2 source-domain acceptance or integrated production acceptance is claimed | `docs/phase_records/PHASE_S2PCT06_AUTHORITATIVE_REPORTS_EVIDENCE.md`; `governance/run_manifests/ADP-S2PCT06-AUTHORITATIVE-REPORTS-EVIDENCE-20260624.json` |
| S2PCT07 | S2PC | completed | ACC-S2PCT07-D2 | V7.1 D2 source-domain qualification readiness passed upstream, domain coverage, replay, shadow, forced-event, queue explanation, and type calibration gates; no D2 formal acceptance or production inclusion is claimed | `docs/phase_records/PHASE_S2PCT07_D2_QUALIFICATION_EVIDENCE.md`; `governance/run_manifests/ADP-S2PCT07-D2-QUALIFICATION-EVIDENCE-20260624.json` |
| S2PDT01 | S2PD | completed | ACC-S2PDT01-C0 | V7.1 China C0 national authority metadata-only source foundation passed official identity, authority taxonomy, document traceability, metadata-only, and no-production gates; no D3 source-domain acceptance or production inclusion is claimed | `docs/phase_records/PHASE_S2PDT01_CHINA_C0_SOURCE_FOUNDATION_EVIDENCE.md`; `governance/run_manifests/ADP-S2PDT01-CHINA-C0-SOURCE-FOUNDATION-EVIDENCE-20260624.json` |
| S2PDT02 | S2PD | completed | ACC-S2PDT02-C1 | V7.1 China C1 central department and key ministry source map passed sector coverage, official identity, alias, industry route, board route, metadata-only, and no-production gates; no D3 source-domain acceptance or production inclusion is claimed | `docs/phase_records/PHASE_S2PDT02_CHINA_C1_DEPARTMENT_SOURCE_MAP_EVIDENCE.md`; `governance/run_manifests/ADP-S2PDT02-CHINA-C1-DEPARTMENT-SOURCE-MAP-EVIDENCE-20260624.json` |
| S2PDT03 | S2PD | completed | ACC-S2PDT03-LEGAL | V7.1 China legal metadata, effectivity/version, reprint/original-source guard, forced rescore, and old-conclusion update shadow evidence passed focused tests and semantic governance; no legal advice, D3 source-domain acceptance, SMTP, Release, scheduler, PDF/full-text download, paid API use, V7.1 CURRENT switch, or V7.2 mail/schema pre-run is allowed | `docs/phase_records/PHASE_S2PDT03_CHINA_LEGAL_METADATA_RELATION_EVIDENCE.md`; `governance/run_manifests/ADP-S2PDT03-CHINA-LEGAL-METADATA-RELATION-EVIDENCE-20260624.json` |
...
| Semantic coverage rollout contract | task-bound machine checks for active parameter values and formula fingerprints | machine_verified; 369 active parameters and all 56 active formulas machine-check, 0 active rows remain HUMAN_REVIEW_REQUIRED |
