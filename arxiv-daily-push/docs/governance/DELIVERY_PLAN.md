...
| S2PDT03 | S2PD | planned | ACC-S2PDT03-LEGAL | Next V7.1 China legal metadata, effectivity/version, and reprint relation shadow; no D3 source-domain acceptance, SMTP, Release, scheduler, PDF/full-text download, paid API use, V7.1 CURRENT switch, or V7.2 mail/schema pre-run is allowed | `docs/pursuing_goal/v7_1/ROADMAP/roadmap_v7.yaml` |
