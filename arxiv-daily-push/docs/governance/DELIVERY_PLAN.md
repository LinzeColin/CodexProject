...
| S2PCT06 | S2PC | planned | ACC-S2PCT06-REPORTS | Next V7.1 authoritative research institution and industry technical report framework; no D2 source-domain acceptance, SMTP, Release, scheduler, PDF/full-text download, paid API use, or paywall bypass is allowed | `docs/pursuing_goal/v7_1/ROADMAP/roadmap_v7.yaml` |
