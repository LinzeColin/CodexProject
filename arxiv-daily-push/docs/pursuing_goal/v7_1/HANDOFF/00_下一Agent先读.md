...
- `HANDOFF/05_Stage1本机日更运行侧线程同步.md` 记录了 Stage1-only 本机 launchd、真实 SMTP 发送、readiness 验收、邮件新模板核验和主线程合并建议。主线程应自行判断是否吸收 `codex/adp-stage1-daily-operation-hardening-20260624` 分支，不得把该记录误用为 Stage2 integrated production acceptance。
