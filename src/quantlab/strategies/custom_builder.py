...
from quantlab.indicators import atr, rsi, sma
from quantlab.storage import locked_json_update, read_json_state
...
class CustomNoCodeStrategy(Strategy):
    description = "No-code custom strategy generated from QuantLab strategy settings."
