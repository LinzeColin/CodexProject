...
from quantlab.system import build_macos_lifecycle_readiness, write_macos_lifecycle_readiness
...
def main() -> None:
    ...
    parser.add_argument("--json", action="store_true", help="Print EVAOSMacOSLifecycleReadinessV1 as JSON.")
    ...
    print(
        "EVA_OS_MACOS_LIFECYCLE_READINESS: "
    ...
    print(f"EVA_OS_MACOS_LIFECYCLE_NEXT_ACTION: {payload['next_action']}")
    if payload.get("outputs"):
        print(f"EVA_OS_MACOS_LIFECYCLE_OUTPUTS: {payload['outputs']}")
