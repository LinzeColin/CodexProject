...
from quantlab.system import write_data_trust_audit


def main() -> None:
    parser = argparse.ArgumentParser(description="Generate a read-only QuantLab Data Trust audit.")
    ...
    if args.json:
        ...
        return
    print(f"QUANTLAB_DATA_TRUST_AUDIT: {payload['audit_status']} {payload['as_of']}")
