...
def main() -> None:
    ...
    parser.add_argument("--json", action="store_true", help="Print EVAOSPolicyReviewedInputRefreshV1 as JSON.")
    ...
    print(
        "EVA_OS_POLICY_REVIEWED_INPUT_REFRESH: "
    ...
    if payload.get("next_action"):
        print(f"EVA_OS_POLICY_NEXT_ACTION: {payload['next_action']}")
    if payload.get("outputs"):
        print(f"EVA_OS_POLICY_REVIEWED_INPUT_OUTPUTS: {payload['outputs']}")
