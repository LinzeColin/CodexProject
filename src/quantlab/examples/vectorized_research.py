...
from quantlab.research.vectorized import build_vectorized_research, write_vectorized_research


def main() -> None:
    parser = argparse.ArgumentParser(description="Run EVA_OS Vectorized Research Mode from EventReplay_latest.json.")
    ...
    if payload.get("outputs"):
        print(f"EVA_OS_VECTORIZED_RESEARCH_OUTPUTS: {payload['outputs']}")
