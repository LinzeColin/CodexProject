...
from quantlab.system.report_validation_hub import (
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run the user-friendly EVA_OS report validation hub.")
    ...
    parser.add_argument("--json", action="store_true", help="Print EVAOSReportValidationHubV1 as JSON.")
    ...
    print(f"EVA_OS_REPORT_VALIDATION_NEXT_ACTION: {payload['next_action']}")
