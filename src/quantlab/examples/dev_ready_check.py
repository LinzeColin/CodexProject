...
from quantlab.system.dev_readiness import build_dev_ready_check, write_dev_ready_check


def main() -> None:
    parser = argparse.ArgumentParser(description="Run the lightweight EVA_OS development readiness check.")
    ...
    parser.add_argument("--json", action="store_true", help="Print EVAOSDevReadyCheckV1 as JSON.")
    ...
    print(f"EVA_OS_DEV_READY_NEXT_ACTION: {payload['next_action']}")
    if payload.get("outputs"):
        print(f"EVA_OS_DEV_READY_OUTPUTS: {payload['outputs']}")
