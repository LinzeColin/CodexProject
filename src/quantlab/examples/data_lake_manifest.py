...
def main() -> None:
    parser = argparse.ArgumentParser(description="Build the EVA_OS reproducible data lake manifest.")
    ...
    if payload.get("outputs"):
        print(f"EVA_OS_DATA_LAKE_MANIFEST_OUTPUTS: {payload['outputs']}")
