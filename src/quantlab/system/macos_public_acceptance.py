...
MACOS_PUBLIC_ACCEPTANCE_SCHEMA = "EVAOSMacOSPublicAcceptanceSummaryV1"
RUNTIME_SCHEMA = "EVAOSMacOSRuntimeAcceptanceV1"
UI_SCHEMA = "EVAOSUIVisualAcceptanceV1"
...
def _coverage(runtime_payload: dict[str, Any] | None, ui_payload: dict[str, Any] | None) -> list[dict[str, str]]:
    return [
        ...
        _coverage_item("Rendered EVA_OS workspace", _ui_check(ui_payload, "VisibleText:EVA_OS")),
