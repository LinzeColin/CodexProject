...
- Generated at: 2026-06-30T06:12:30+08:00
...
| benchmark_dynamic_window | Benchmark | pass | info | default window is latest Beijing weekday plus 396-day lookback | `app/core/benchmark_smoke.py` |
| formal_pdf | Deliverables | pass | info | exists=True, size=171384 | `outputs/preflight/PRODUCTION_READINESS_REPORT.pdf` |
| task_pack | Deliverables | pass | info | exists=True, size=1560 | `outputs/task_pack/13_CODEX_PROMPT.md` |
| launchd_plist | Deliverables | pass | info | exists=True, size=1219 | `outputs/implementation/com.serenity.daily-analysis.plist` |
| codex_automation_notes | Deliverables | pass | info | exists=True, size=1573 | `outputs/implementation/CODEX_AUTOMATION_PROPOSALS.md` |
| application_portal | Deliverables | pass | info | exists=True, size=183712 | `outputs/application/index.html` |
...
| codex_app_automation_active | Automation | pass | info | serenity-daily-analysis-beijing-hour-slots=PAUSED; serenity-daily-analysis-beijing-half-hour-slots=PAUSED | `outputs/implementation/CODEX_AUTOMATION_READY.md` |
| launchd_schedule_contract | Automation | pass | info | StartInterval=180, command=automation-tick, env={'PATH': '/opt/anaconda3/bin:/usr/bin:/bin:/usr/sbin:/sbin', 'SERENITY_OPEND_WAIT_SECONDS': '75'} | `outputs/implementation/com.serenity.daily-analysis.plist` |
...
| final_zip_integrity | Deliverables | pass | info | 461 members | `outputs/package/serenity_daily_analysis_delivery.zip` |
...
| readiness_report_package_consistency | Deliverables | pass | info | report matches package member_count=461, private_members=0 | `outputs/preflight/PRODUCTION_READINESS_REPORT.md` |
| readiness_report_benchmark_consistency | Deliverables | pass | info | 000001.SH: rows=261, latest=2026-06-26; SPX: rows=271, latest=2026-06-29 | `outputs/preflight/PRODUCTION_READINESS_REPORT.md` |
...
| shadow_ready_gate | Production Gate | pass | info | shadow_ready=True, production_ready=True | `outputs/preflight/preflight_latest.json` |
| mail_send_config_gate | Notification | pass | info | {'mail_send_enabled': True, 'recipient_email': 'linzezhang35@gmail.com', 'activation_hint': '--send-mail'} | `outputs/preflight/preflight_latest.json` |
| moomoo_opend_gate | Data Source | pass | info | moomoo_OpenD socket reachable at 127.0.0.1:11111; Python import `moomoo` is available; installed distribution version=10.8.6808 | `outputs/preflight/preflight_latest.json` |
| benchmark_gate | Benchmark | pass | info | {'production_ready_by_benchmark': {'S&P 500': True, 'Shanghai Composite': True}, 'proxy_available': {'S&P 500': True, 'Shanghai Composite': False}, 'auto_start_skipped_for_preflight': True, 'json_path': 'outputs/preflight/benchmark_smoke_latest.json', 'markdown_path': 'outputs/preflight/benchmark_smoke_latest.md'} | `outputs/preflight/preflight_latest.json` |
...
| holdings_review_matrix | Data Quality | warn | warn | review_rows=28, matrix_exists=False, row_production_candidate_count=0, stale_or_missing_date_count=28, special_rule_count=12 | `outputs/preflight/holdings_discovery_latest.json` |
...
| latest_strategy_report | Reporting | pass | info | run_id=sda_20260629T092738Z_r10_0e1f8b98, status=success, data_quality_status=pass, markdown=True, html=True | `data/reports/sda_20260629T092738Z_r10_0e1f8b98_report.md` |
| production_slot_backfill_verified | Automation | pass | info | run_id=sda_20260629T092738Z_r10_0e1f8b98, run_time_bj=2026-06-29T17:30:00+08:00, verification_kind=live_or_past_run, tick_action=ran, dry_run=0, sent_notifications=0, non_actionable_local_notifications=1 | `data/serenity_daily.sqlite` |
| offline_web_index_updates_latest | Web | pass | info | index=data/reports/index.html, latest_html=sda_20260629T092738Z_r10_0e1f8b98_report.html, linked=True | `data/reports/index.html` |
| source_traceability | Evidence | pass | info | run_id=sda_20260629T092738Z_r10_0e1f8b98, source_log_rows=49 | `data/serenity_daily.sqlite` |
| top5_weights | Recommendation | pass | info | run_id=sda_20260629T092738Z_r10_0e1f8b98, top5_weight_rows=5 | `data/serenity_daily.sqlite` |
| score_grade_mapping | Scoring | pass | info | run_id=sda_20260629T092738Z_r10_0e1f8b98, distinct_grade_count=4 | `data/serenity_daily.sqlite` |
| conservative_exclusion | Filtering | pass | info | excluded_bond_like_assets=1 | `data/serenity_daily.sqlite` |
| hard_risk_gate_evidence | Risk | pass | info | run_id=sda_20260629T092738Z_r10_0e1f8b98, hard_gate_review_rows=0, regression_status=pass, passed_cases=['max_drawdown_block', 'recovery_time_block'] | `outputs/tests/risk_gate_regression_latest.json` |
| same_day_and_period_comparisons | Comparison | pass | info | run_id=sda_20260629T092738Z_r10_0e1f8b98, comparison_types=['previous_day', 'previous_month', 'previous_week', 'same_day_previous'] | `data/serenity_daily.sqlite` |
| discipline_actions | Discipline | pass | info | run_id=sda_20260629T092738Z_r10_0e1f8b98, decision_rows=10, rebalance_events=7 | `data/serenity_daily.sqlite` |
| notification_drafts | Notification | pass | info | run_id=sda_20260629T092738Z_r10_0e1f8b98, notification_rows=2 | `data/serenity_daily.sqlite` |
| execution_lock_zero_order | Safety | pass | info | data_quality_status=pass, report_locked=False, notification_locked=False | `data/reports/sda_20260629T092738Z_r10_0e1f8b98_report.md` |
