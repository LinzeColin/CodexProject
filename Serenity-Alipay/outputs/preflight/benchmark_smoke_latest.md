...
- Window: 2025-06-13 to 2026-07-14 (dynamic_latest_weekday)
...
- Hang Seng TECH ETF proxy `HSTECH_PROXY` via `3033.HK` (thematic_proxy): pass rows=264 - ok
- ChiNext Index `399006.SZ` via `0.399006` (thematic_index): pass rows=264 - ok
