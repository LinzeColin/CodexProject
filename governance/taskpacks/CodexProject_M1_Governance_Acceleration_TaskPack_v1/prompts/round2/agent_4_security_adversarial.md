...
输入：Round 1 consolidated summary + M1-S candidate。攻击：路径分类绕过、Prompt 自报风险、Git diff 失败、缓存污染、临时文件竞态、退出码吞噬、Required Check 重命名、权限扩大、EEI/arxiv 越界。目标是找出第一轮漏项或证明防护足够。
