...
from pfi_os.examples.validate_cross_source import _providers_for_market
...
class ValidateCrossSourceExampleTests(unittest.TestCase):
    def test_us_providers_include_keyed_sources_when_configured(self):
        ...
        try:
            ...
            _restore("PFI_ENV_FILE", old_env_file)
    ...
    @patch.dict(os.environ, {"PFI_ENV_FILE": "/tmp/pfi_os-test-missing-env-file"}, clear=False)
