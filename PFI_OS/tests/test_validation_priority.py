...
from pfi_os.research import build_validation_priority_plan, validation_priority_frame, write_validation_priority_plan
...
def test_validation_priority_plan_ranks_foundational_evidence_first(tmp_path: Path) -> None:
    ...
    assert payload["schema"] == "PFIOSValidationTaskPriorityPlanV1"
