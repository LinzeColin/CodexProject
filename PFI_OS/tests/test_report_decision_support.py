...
from pfi_os.reports import build_report_decision_support_index, report_decision_support_markdown, write_report_decision_support_index
...
def test_report_decision_support_classifies_evidence_status(tmp_path: Path) -> None:
    ...
    assert payload["schema"] == "PFIOSReportDecisionSupportIndexV1"
...
def test_write_report_decision_support_outputs_json_csv_markdown_pdf_and_latest(tmp_path: Path) -> None:
    ...
    assert saved["schema"] == "PFIOSReportDecisionSupportIndexV1"
