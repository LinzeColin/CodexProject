...
from pfi_os.data.validation import save_cross_source_validation_result, validate_close_across_sources
...
class ValidationTests(unittest.TestCase):
    def test_cross_source_validation_passes_close_sources(self):
        ...
        with patch("pfi_os.data.validation.make_provider", side_effect=factory):
