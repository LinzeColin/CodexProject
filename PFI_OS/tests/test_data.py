...
from pfi_os.data.cleaner import normalize_ohlcv, resample_bars
from pfi_os.data.intervals import get_bars_with_interval_fallback, pandas_interval_rule
...
class DataTests(unittest.TestCase):
    ...
    def test_store_round_trip(self):
        ...
        store = DataStore(root="/tmp/pfi_os-test-store", format="csv")
