...
from pfi_os.integrations.holdings_book import HoldingSourceSpec, default_alipay_ledger_dirs
...
def test_default_alipay_dirs_require_explicit_external_private_path(monkeypatch):
    monkeypatch.delenv("PFI_ALIPAY_LEDGER_DIR", raising=False)
...
def test_holdings_sync_history_accepts_schema_wrapped_history():
    with TemporaryDirectory() as tmp:
        ...
        history_path.write_text(
            '{"schema":"PFIOSHoldingsImportHistoryV1","history":[{"synced_at":"2026-06-04T22:16:41","raw_row_count":0,"canonical_row_count":28,"source_file_count":1}]}',
            encoding="utf-8",
        )
