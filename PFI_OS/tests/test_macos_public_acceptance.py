...
def test_public_acceptance_summary_redacts_local_runtime_and_ui_evidence(tmp_path: Path) -> None:
        ...
        json.dumps(
            {
                ...
                "project_root": "/Users/linzezhang/private/PFI_OS",
                "summary": {"pass": 10, "fail": 0, "info": 0, "total": 10},
                "started_by_acceptance": True,
                "launch_method": "app",
                "checks": [
                    {"check": "AppOpenLaunched", "status": "Pass", "evidence": "opened=/Users/linzezhang/Downloads/PFI_OS.app"},
                ...
                "outputs": {"latest_json": "/Users/linzezhang/private/PFI_OS/data/systemAudit/MacOSRuntimeAcceptance_latest.json"},
            }
        ),
        encoding="utf-8",
    )
        ...
        json.dumps(
            {
                ...
                "started_by_acceptance": True,
                "checks": [
                    {"name": "VisibleText:PFI_OS", "status": "Pass", "evidence": "PFI_OS"},
                ...
                "outputs": {"screenshot": "/Users/linzezhang/private/PFI_OS/data/systemAudit/UIVisualAcceptance.png"},
    ...
    assert payload["schema"] == "PFIOSMacOSPublicAcceptanceSummaryV1"
        ...
        json.dumps(
            {
                ...
                "checks": [
                    {"name": "VisibleText:PFI_OS", "status": "Pass"},
