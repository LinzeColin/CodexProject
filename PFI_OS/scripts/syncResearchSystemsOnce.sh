...
run_step "PFIOS chat dropbox" scripts/researchBusApi.sh process-dropbox --min-age-seconds 0 --limit 100 --json
run_step "PFIOS heartbeat" scripts/researchBusApi.sh heartbeat \
...
run_step "PFIOS request processing" scripts/researchBusApi.sh process --system-name ResearchBus --limit 100 --json
run_step "PFIOS child system registry" scripts/orchestrateSystems.sh register --json
run_step "PFIOS child system artifacts" scripts/orchestrateSystems.sh sync-artifacts --json
run_step "PFIOS research bus sync" scripts/syncResearchBus.sh --json
