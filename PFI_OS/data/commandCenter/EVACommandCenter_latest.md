# PFI_OS Command Center 2026-06-13
...
| IntegrationAudit | Pass | summary={'pass': 6, 'review': 0, 'fail': 0, 'item_count': 6} | Run scripts/auditPFIIntegration.sh --no-write if not Pass. |
...
| EntityRegistry | Pass | Entity Registry schema=PFIOSEntityRegistryV1; records=28. | 确认 ProxyMapped 和 MissingSymbol 的报告口径。 |
...
| --- | --- | --- | --- | --- |
| P1 | Open | PFIOS | Configure provider API keys only for the data sources you actually use; do not store keys in source code. | Daily Readiness |
| P1 | Open | PFIOS | Open the latest report from Report Center and check data quality, cross-source validation, and risk gates before using it. | Daily Readiness |
...
| --- | --- | --- | --- |
| Daily Readiness | Present | /Users/linzezhang/Documents/Codex/2026-06-13/files-mentioned-by-the-user-eva/outputs/CodexFinance/data/systemAudit/PFIOSDailyReadiness_07062026.json | PFIOSDailyReadinessV1 |
| Integration Audit | Present | /Users/linzezhang/Documents/Codex/2026-06-13/files-mentioned-by-the-user-eva/outputs/CodexFinance/data/systemAudit/PFIOSIntegrationAudit_07062026.json | PFIOSIntegrationAuditV1 |
| Data Trust Audit | Present | /Users/linzezhang/Documents/Codex/2026-06-13/files-mentioned-by-the-user-eva/outputs/CodexFinance/data/systemAudit/PFIOSDataTrustAudit_07062026.json | PFIOSDataTrustAuditV1 |
...
| Company CashFlow Command | Missing | /Users/linzezhang/Documents/Codex/2026-06-13/files-mentioned-by-the-user-eva/outputs/CodexFinance/data/cashflow/CompanyCashFlowCommand_latest.json | PFIOSCompanyCashFlowCommandV1 |
| Policy Intelligence Radar | Present | data/policy/PolicyIntelligenceRadar_latest.json | PFIOSPolicyIntelligenceRadarV1 |
| Consumption Guard | Present | data/consumption/ConsumptionGuard_latest.json | PFIOSConsumptionGuardV1 |
