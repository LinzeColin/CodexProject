...
def main() -> None:
    ...
    parser.add_argument("--launch-method", choices=["script", "app"], default="script", help="Use quiet script start or real PFI_OS.app open.")
    parser.add_argument("--app-path", default=None, help="Optional PFI_OS.app path when --launch-method app is used.")
    parser.add_argument(
