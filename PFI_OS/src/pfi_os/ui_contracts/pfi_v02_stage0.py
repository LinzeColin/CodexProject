...
PUBLIC_ASSUMPTION_COMPATIBILITY: tuple[CompatibilityEntry, ...] = (
    CompatibilityEntry("PFI/大数据模拟器", True, "TaskPack public assumption; current local equivalent is PFI_OS strategy simulation", "投资管理 > 策略实验室 / 大数据模拟器", "如果该公开路径在其他 checkout 存在，必须保留；本地以 PFI_OS 模拟实验兼容。", "MappedPublicAssumption"),
