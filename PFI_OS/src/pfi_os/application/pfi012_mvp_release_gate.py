...
PFI012_RELEASE_DISPOSITIONS: tuple[dict[str, str], ...] = (
    ...
    {"id": "PFI-F016", "severity": "P1", "stage": "PFI-003", "disposition": "Closed", "evidence": "stopPFIOS + shutdown monitor"},
    ...
    {"id": "PFI-F019", "severity": "P1", "stage": "Phase A", "disposition": "Closed", "evidence": "$PFI_OS_DATA_HOME private/derived policy"},
