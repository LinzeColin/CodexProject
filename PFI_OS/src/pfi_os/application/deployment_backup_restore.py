...
def build_phase_d_backup_restore_contract(
    ...
    return {
        ...
        "required_input": "$PFI_OS_DATA_HOME/private/operational/pfi.sqlite",
        "artifact_policy": {
...
def _preflight_checks(project_root: Path, data_home: Path, operational_db: Path) -> list[dict[str, Any]]:
    return [
        _check(
            ...
            required=True,
            message="$PFI_OS_DATA_HOME must stay outside public Git before backup/restore acceptance.",
        ...
        _check(
            ...
            required=True,
            message="Backup target is scoped under $PFI_OS_DATA_HOME/runtime/backups.",
            evidence_scope="path_policy",
        ),
        _check(
            category="backup_restore",
            ...
            required=True,
            message="Restore staging is scoped under $PFI_OS_DATA_HOME/runtime/restore_staging.",
            evidence_scope="path_policy",
        ),
    ]
...
def _payload(
    *,
    ...
    public_summary = {
        ...
        "backup_scope": "$PFI_OS_DATA_HOME/runtime/backups",
        "restore_scope": "$PFI_OS_DATA_HOME/runtime/restore_staging",
