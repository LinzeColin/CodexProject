...
Continue with Gate 3 / PFI-006 Markets vertical slice after replaying the new
Gate 2 shell acceptance locally. Gate 1 and Gate 2 are closed for the current
evidence scope and must be re-run in the final Gate 7 release package.
