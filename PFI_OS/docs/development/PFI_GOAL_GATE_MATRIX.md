...
Continue with Gate 2 / PFI-005 formal user-facing shell acceptance: four named
fixture UAT journeys, accessibility proof, performance budget, and no
legacy-page import gate. Gate 1 is closed for the current evidence scope and
