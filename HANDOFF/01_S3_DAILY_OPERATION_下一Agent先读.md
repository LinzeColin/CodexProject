...
| 当前治理 gate | `V03_R0_R4_DELIVERED_ZERO_PRODUCTION_SIDE_EFFECTS_AWAITING_OWNER_PILOT_DECISION`；该 gate 只说明授权前置判定已失败关闭，不创建授权、不授权 DAILY_OPERATION | `arxiv-daily-push/docs/governance/VERSION_MATRIX.yaml` |
