...
这是 Memory Atlas v1.2 的人类入口。当前阶段是 S05 P2：facet extractor
已完成。任务 ID 为 `MA-V12-S05P2`，验收 ID 为 `ACC-MA-V12-S05P2`，
状态为 `phase_s05_p2_facet_extractor_completed_pending_s05_p3`。
...
extractor，并生成 `data/derived/behavior_intelligence/events.json`。下一步只允许进入
S05 P3。
...
下一步只允许进入 S05 P3。整体 S01-S14 全部完成前不上传 GitHub main。
