...
这是 Memory Atlas v1.2 的人类入口。当前阶段是 S06 P1：Cluster builder 已完成。
任务 ID 为 `MA-V12-S06P1`，验收 ID 为 `ACC-MA-V12-S06P1`，状态为
`phase_s06_p1_cluster_builder_completed_pending_s06_p2`。
...
`source/time/project/task/language` 过滤合同。下一步只允许进入 S06 P2。
