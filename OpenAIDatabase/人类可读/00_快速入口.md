...
这是 Memory Atlas v1.2 的人类入口。当前阶段是 S07 Review。任务 ID 为
`MA-V12-S07-REVIEW`，验收 ID 为 `ACC-MA-V12-S07-REVIEW`，状态为
`stage_s07_review_passed_pending_s08_no_github_main_upload`。
