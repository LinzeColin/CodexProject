...
这是 Memory Atlas v1.2 的人类入口。当前阶段是 S09 Review。任务 ID 为
`MA-V12-S09-REVIEW`，验收 ID 为 `ACC-MA-V12-S09-REVIEW`，状态为
...
list、psychological diagnosis output 或 personality label output。下一步只允许进入 S10 P1。
