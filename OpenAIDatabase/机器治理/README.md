...
当前为 S06 P2。任务 ID 为 `MA-V12-S06P2`，验收 ID 为
...
`data/derived/behavior_intelligence/low_value_loops.json`。下一步是 S06 P3。
...
下一步是 S06 P3；本目录仍不替代 apps/scripts/tests/config/data/docs/governance。
