...
## 18. Root Workflow Consolidation

- local_status: `PASS`
- task / acceptance: `TSK.CodexProject.REPO1.0005` / `ACC.CodexProject.REPO1.0005`
- effect: nested OpenAIDatabase CI was merged into the executable root workflow; model, parameter values, product version, data, deployment, and delivery readiness are unchanged.
- remote_status: `PENDING_WHOLE_PACKAGE_PUBLICATION`

## 19. MacData Main-Only Migration

- local_status: `PASS`
- task / acceptance: `TSK.OpenAIDatabase.CLEAN1.0001` / `ACC.OpenAIDatabase.CLEAN1.0001`
- preserved_snapshots: `airM2 17 files / 90278 bytes; proM2 17 files / 101713 bytes`
- producer_contract: `main only; unique automation-c PR; trusted Settlement; exact SHA256; terminal 0/0/0`
- tests: `25 focused tests PASS; both local simulations PASS; remote writes 0`
- remote_status: `PENDING_WHOLE_PACKAGE_PUBLICATION`
- owner_action_now: `NONE`; continue the sequential Task Pack.

## 20. Repository Hygiene

- local_status: `PASS_LOCAL_ENGINEERING`
- task / acceptance: `TSK.CodexProject.REPO1.0006` / `ACC.CodexProject.REPO1.0006`
- effect: future large/archive/runtime-noise and whole-repository backup producers fail closed; scheduled raw-session tar commits are disabled; one verified duplicate transfer tar is removed.
- retained_risk: the 38.3 MB June raw-session tar stays baseline-locked until a SHA-256 verified private recovery copy exists; the historical Git pack remains about 3.54 GiB.
- product/model/deployment/readiness: `UNCHANGED`
- history_rewrite: `NOT_AUTHORIZED`
- remote_status: `PENDING_WHOLE_PACKAGE_PUBLICATION`
- owner_action_now: `NONE`; continue the sequential Task Pack after local commit.
