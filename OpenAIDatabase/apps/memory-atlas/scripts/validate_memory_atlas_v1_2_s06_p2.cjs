...
function validateDocsAndRecords() {
  ...
  assertCondition(
    hasAll(runGate, ["当前阶段是 S06 P2", taskId, acceptanceId, validatorName, reviewPath, "下一步是 S06 P3"]),
    "s06p2_run_gate",
