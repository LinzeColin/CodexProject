...
function validateRuntimeContract() {
  ...
  assertCondition(
    !hasAll(app, ["Codex/Agent Decision Sankey", "Friction Heatmap", "Latent Radar", "Evidence Timeline", "Formula Explorer"]),
    "s11p2_phase_boundary",
    "S11 P2 runtime does not implement S11 P3/P4 visual families",
    "S11 P2 appears to include later S11 visual families",
  );
  assertCondition(
    hasAll(styles, [
