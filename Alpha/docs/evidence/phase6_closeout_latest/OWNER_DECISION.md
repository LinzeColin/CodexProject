...
| 验收项 | 当前状态 | 证据状态 | 证据时间 |
|---|---|---|---|
| `phase6_48h_soak_validation` | `blocked` | `observing` | `2026-06-27T06:39:46+00:00` |
| `qualified_trading_day_paper_shadow_report` | `pass` | `pass` | `2026-06-27T06:37:46+00:00` |
| `shadow_live_constraints` | `pass` | `pass` | `2026-06-27T06:37:46+00:00` |
| `limit_order_contract` | `pass` | `pass` | `2026-06-27T06:37:46+00:00` |
