# PFI_BIG_DATA_SIMULATOR 中文 Owner 快速入口
...
## 一句话结论
PFI 大数据模拟器项目，当前重点是让 Owner 快速理解模拟范围、输入输出、验证证据和不可承诺的业务含义。
...
- active_parameter_count: `213`
- 总模型数：`15`；总公式数：`15`；总参数数：`213`。
...
# PFI_BIG_DATA_SIMULATOR 中文 Owner 可读入口
