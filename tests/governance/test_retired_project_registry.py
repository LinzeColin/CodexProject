...
class RetiredProjectRegistryTests(unittest.TestCase):
    ...
    def test_wave1_migrated_projects_are_registered_with_evidence_and_removed(self) -> None:
        ...
        self.assertEqual(
            set(migrated),
            {"whkmSalary", "Alpha", "FIFA", "QBVS", "MetaDatabase"},
        )
    ...
    def test_root_change_fans_out_to_active_required_projects_only(self) -> None:
        ...
        self.assertEqual(selection["required_project_count"], 7)
        self.assertEqual(selection["selected_required_project_count"], 7)
