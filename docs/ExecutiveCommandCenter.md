...
总控驾驶舱是 EVA_OS 的第一入口，用来回答一个问题：当前系统是否可以继续研究，还是必须先补证据、修风险或生成报告。
...
```bash
$EVA_OS_HOME/scripts/refreshRuntimeSummaries.sh --as-of 2026-06-16
```
...
```text
data/commandCenter/EVACommandCenter_DDMMYYYY.json
data/commandCenter/EVACommandCenter_DDMMYYYY.md
data/commandCenter/EVACommandCenter_DDMMYYYY.pdf
