...
Daily Readiness 是 QuantLab 的日常开机前只读检查入口，用来回答：今天这个研究工作台是否可以进入研究流程，哪些数据源或本地设置还需要处理。
...
```bash
$EVA_OS_HOME/scripts/dailyCheck.sh --output-dir data/systemAudit --network
```
...
| 文件 | 用途 |
| --- | --- |
| `QuantLabDailyReadiness_DDMMYYYY.json` | 机器可读完整状态 |
| `QuantLabDailyReadiness_DDMMYYYY.md` | 人工阅读摘要 |
| `QuantLabDailyReadiness_DDMMYYYY.pdf` | 轻量正式检查页 |

2026-06-07 当前已生成：

- `data/systemAudit/QuantLabDailyReadiness_07062026.json`
- `data/systemAudit/QuantLabDailyReadiness_07062026.md`
- `data/systemAudit/QuantLabDailyReadiness_07062026.pdf`
