...
QuantLab 仅用于研究、回测和辅助分析。

QuantLab is for research, backtesting, and assisted analysis only.

QuantLab 产出的结果可以作为实盘交易前的参考，但不能保证收益。

QuantLab outputs may support real trading decisions, but they do not guarantee profit.
