...
```bash
$EVA_OS_HOME/scripts/macosAcceptance.sh --list-modes
```
...
```bash
$EVA_OS_HOME/scripts/macosAcceptance.sh --mode runtime --summary-json
```
...
```bash
$EVA_OS_HOME/scripts/checkMoomoo.sh --strict
```
