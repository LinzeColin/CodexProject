  ...
  "routes": [
    {
      ...
      "default_forbidden_paths": ["AGENTS.md", "EEI/**", "FIFA/**", "KMFA/**", "MetaDatabase/**", "OpenAIDatabase/**", "KM_IDSystem/**", "PFI/**", "QBVS/**", "Serenity-Alipay/**", "arxiv-daily-push/**", "whkmSalary/**"],
      "validation_commands": [],
    ...
    },
    {
      ...
      "default_forbidden_paths": ["AGENTS.md", "Alpha/**", "FIFA/**", "KMFA/**", "MetaDatabase/**", "OpenAIDatabase/**", "KM_IDSystem/**", "PFI/**", "QBVS/**", "Serenity-Alipay/**", "arxiv-daily-push/**", "whkmSalary/**"],
      "validation_commands": [],
    ...
    },
    {
      ...
      "default_forbidden_paths": ["AGENTS.md", "Alpha/**", "EEI/**", "KMFA/**", "MetaDatabase/**", "OpenAIDatabase/**", "KM_IDSystem/**", "PFI/**", "QBVS/**", "Serenity-Alipay/**", "arxiv-daily-push/**", "whkmSalary/**"],
      "validation_commands": [],
    ...
    },
    {
      ...
      "default_forbidden_paths": ["AGENTS.md", "Alpha/**", "EEI/**", "FIFA/**", "MetaDatabase/**", "OpenAIDatabase/**", "KM_IDSystem/**", "PFI/**", "QBVS/**", "Serenity-Alipay/**", "arxiv-daily-push/**", "whkmSalary/**"],
      "validation_commands": [],
    ...
    },
    {
      ...
      "default_forbidden_paths": ["AGENTS.md", "Alpha/**", "EEI/**", "FIFA/**", "KMFA/**", "OpenAIDatabase/**", "KM_IDSystem/**", "PFI/**", "QBVS/**", "Serenity-Alipay/**", "arxiv-daily-push/**", "whkmSalary/**"],
      "validation_commands": [],
    ...
    },
    {
      ...
      "default_forbidden_paths": ["AGENTS.md", "Alpha/**", "EEI/**", "FIFA/**", "KMFA/**", "MetaDatabase/**", "KM_IDSystem/**", "PFI/**", "QBVS/**", "Serenity-Alipay/**", "arxiv-daily-push/**", "whkmSalary/**"],
      "validation_commands": [],
    ...
    },
    {
      ...
      "default_allowed_paths": ["KM_IDSystem/**"],
      ...
      "validation_commands": [],
      "validation_na_reason": "KM_IDSystem validation must be task-specific because operational automation may touch runtime boundaries.",
      "t2_triggers": ["operational automation", "credentials boundary", "production"],
      "split_when": ["Task changes KM_IDSystem and another project"]
    },
    {
      "project": "PFI",
      "aliases": ["pfi"],
      "default_allowed_paths": ["PFI/**"],
      "default_forbidden_paths": ["AGENTS.md", "Alpha/**", "EEI/**", "FIFA/**", "KMFA/**", "MetaDatabase/**", "OpenAIDatabase/**", "KM_IDSystem/**", "QBVS/**", "Serenity-Alipay/**", "arxiv-daily-push/**", "whkmSalary/**"],
      "validation_commands": [],
    ...
    },
    {
      ...
      "default_forbidden_paths": ["AGENTS.md", "Alpha/**", "EEI/**", "FIFA/**", "KMFA/**", "MetaDatabase/**", "OpenAIDatabase/**", "KM_IDSystem/**", "PFI/**", "Serenity-Alipay/**", "arxiv-daily-push/**", "whkmSalary/**"],
      "validation_commands": [],
    ...
    },
    {
      ...
      "default_forbidden_paths": ["AGENTS.md", "Alpha/**", "EEI/**", "FIFA/**", "KMFA/**", "MetaDatabase/**", "OpenAIDatabase/**", "KM_IDSystem/**", "PFI/**", "QBVS/**", "arxiv-daily-push/**", "whkmSalary/**"],
      "validation_commands": [],
    ...
    },
    {
      ...
      "default_forbidden_paths": ["AGENTS.md", "Alpha/**", "EEI/**", "FIFA/**", "KMFA/**", "MetaDatabase/**", "OpenAIDatabase/**", "KM_IDSystem/**", "PFI/**", "QBVS/**", "Serenity-Alipay/**", "whkmSalary/**"],
      "validation_commands": [],
    ...
    },
    {
      ...
      "default_forbidden_paths": ["AGENTS.md", "Alpha/**", "EEI/**", "FIFA/**", "KMFA/**", "MetaDatabase/**", "OpenAIDatabase/**", "KM_IDSystem/**", "PFI/**", "QBVS/**", "Serenity-Alipay/**", "arxiv-daily-push/**"],
      "validation_commands": [],
...
| `KM_IDSystem` | `["KM_IDSystem/**"]` | N/A until Task Pack identifies runnable OpMe checks | operational automation, credentials boundary, production |
