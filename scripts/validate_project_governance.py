...
def validate_arxiv_daily_push_v7_root_lock(
    ...
    for rel_path in ("功能清单", "开发记录", "模型参数文件"):
        ...
        for needle in ("ADP-PRODUCT-CONTRACT-V7.1", "V7_1_ROOT_LOCK.yaml", "ARXIV_PRODUCTION_ACCEPTED", "S2PCT01", "S2P2T01", "S2PCT02", "S2P2T02", "S2PCT03", "S2P2T03", "S2PCT04", "S2P2T04", "S2PCT05", "S2PBT01"):
            if needle not in text:
