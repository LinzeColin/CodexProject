    ...
    if str(project_facts.get("project_id") or "") == "arxiv-daily-push":
        lines.extend(
            [
                ...
                "| 证据入口 | [PHASE_S2PMT04_PROCESS_LIFECYCLE_B002.md](docs/phase_records/PHASE_S2PMT04_PROCESS_LIFECYCLE_B002.md)；[ADP-S2PMT04-PROCESS-LIFECYCLE-B002-20260627.json](../governance/run_manifests/ADP-S2PMT04-PROCESS-LIFECYCLE-B002-20260627.json)；[PHASE_S2PMT04_CACHE_LOW_DISK_B005.md](docs/phase_records/PHASE_S2PMT04_CACHE_LOW_DISK_B005.md)；[ADP-S2PMT04-CACHE-LOW-DISK-B005-20260626.json](../governance/run_manifests/ADP-S2PMT04-CACHE-LOW-DISK-B005-20260626.json) |",
                "",
                "## S2PMT05 本地重复触发竞态门",
                "",
                "| 项目 | 当前口径 |",
