...
if PYTHONDONTWRITEBYTECODE=1 PYTHONPATH=src .venv/bin/python -m quantlab.examples.validate_cross_source --market US --symbol AAPL --start 2024-01-01 --end 2024-01-31; then
...
echo "Validating CN cross-source data when enough providers are configured..."
    if PYTHONDONTWRITEBYTECODE=1 PYTHONPATH=src .venv/bin/python -m quantlab.examples.validate_cross_source --market CN --symbol 600000 --start 2024-01-01 --end 2024-01-31; then
