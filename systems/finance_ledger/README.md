...
This directory is the EVA_OS landing zone for the local Consumption Analysis / Finance Ledger system.
...
1. Add an EVA_OS adapter that publishes only summarized cashflow, category, risk-tag, and review-queue metrics to ResearchBus.
