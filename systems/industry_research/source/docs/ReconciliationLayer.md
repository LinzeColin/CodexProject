...
- QuantLab bridge rows with `Review`, `Blocked`, `NeedsMoreEvidence`, `DataQualityReview`, or `DoNotUse` are downgraded.
...
- If QuantLab bridge rows are weak or blocked, they can only support observation or further validation.
