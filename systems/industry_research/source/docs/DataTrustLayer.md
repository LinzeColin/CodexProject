...
- QuantLab bridge JSON files
- QuantLab validation summaries
...
- QuantLab rows marked `Review`, `Blocked`, `NeedsMoreEvidence`, `DataQualityReview`, or `DoNotUse` must downgrade research conclusions.
