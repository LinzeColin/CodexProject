...
class ResearchBusBridgeTest(unittest.TestCase):
    def test_ai_research_bridge_publishes_reports_and_pulls_quantlab_state(self) -> None:
        with tempfile.TemporaryDirectory() as tmp:
            ...
            self.assertEqual(payload["quantlab_result_count"], 1)
            ...
            self.assertTrue(Path(payload["quantlab_results_path"]).exists())
            ...
            pulled = json.loads(Path(payload["quantlab_results_path"]).read_text(encoding="utf-8"))
