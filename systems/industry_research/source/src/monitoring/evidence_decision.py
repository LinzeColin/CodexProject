...
def build_evidence_decision_matrix(
    ...
    *,
    ...
    return {
        ...
        "assumptions": [
            "This matrix is read-only and composes existing local audit artifacts; it does not refresh OpenD, moomoo, Alipay, policy bridge, QuantLab, or ResearchBus.",
...
def _blocker_scope(priority: str, decision: str, layer: str, domain: str, item_name: str, issue: str) -> str:
    ...
    if "quantlab" in text:
        return "QuantLab validation evidence must remain observation or further validation."
