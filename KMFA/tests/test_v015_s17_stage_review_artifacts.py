...
class S17StageReviewArtifactTests(unittest.TestCase):
    ...
    def test_public_evidence_accounting_is_exact(self) -> None:
        ...
        self.assertEqual(
            verification["accounting"], {"total": 253, "passed": 253, "failed": 0}
        )
        cross = json.loads(
    ...
    def test_findings_and_risks_are_honestly_closed_or_routed(self) -> None:
        ...
        self.assertTrue(
            all(
                ...
                and row["blocks_s17_stage_acceptance"] == "false"
                for row in risks
            )
        )
