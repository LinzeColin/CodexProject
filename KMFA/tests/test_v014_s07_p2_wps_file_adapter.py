...
class TestV014S07P2WpsFileAdapter(unittest.TestCase):
    def test_wps_file_adapter_is_public_safe_versioned_and_local_only(self) -> None:
        ...
        self.assertEqual(result["private_runtime_registry_ref"], "PRIVATE_REGISTRY::V014_S07_P2_RUNTIME")
        ...
        self.assertEqual(result["private_binding_revalidation_required_count"], 20)
