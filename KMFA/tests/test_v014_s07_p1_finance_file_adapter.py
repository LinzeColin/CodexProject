...
class TestV014S07P1FinanceFileAdapter(unittest.TestCase):
    def test_finance_file_adapter_is_public_safe_and_local_only(self) -> None:
        ...
        self.assertEqual(result["worktree"], "repo://KMFA")
        self.assertEqual(result["raw_inbox_ref"], "PRIMARY_RAW_ROOT")
        self.assertEqual(result["private_runtime_registry_ref"], "PRIVATE_REGISTRY::V014_S07_P1_RUNTIME")
        ...
        self.assertEqual(result["private_binding_revalidation_required_count"], 45)
