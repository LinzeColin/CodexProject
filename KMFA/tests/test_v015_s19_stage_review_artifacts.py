...
class S19StageReviewArtifactTests(unittest.TestCase):
    ...
    def test_public_evidence_accounting_is_exact(self) -> None:
        ...
        self.assertEqual(verification["accounting"], {"total": 278, "passed": 278, "failed": 0})
    ...
    def test_findings_and_residual_risks_are_honest(self) -> None:
        ...
        self.assertEqual([row["finding_id"] for row in findings], ["S19REV-F001", "S19REV-F002"])
    ...
    def test_human_reports_are_plain_chinese(self) -> None:
        ...
        for phrase in ("三步页面导航中断", "被手工篡改的专业复核记录"):
            self.assertIn(phrase, review)
        self.assertIn("278/278", tests)
