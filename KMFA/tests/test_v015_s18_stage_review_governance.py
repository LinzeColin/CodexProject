...
FORMULA_ID = "FORM-KMFA-V015-S18-STAGE-REVIEW-001"


class V015S18StageReviewGovernanceTests(unittest.TestCase):
    def test_registry_bindings(self) -> None:
        ...
        selected = [
            ...
            and 2646 <= int(row["parameter_id"].rsplit("-", 1)[-1]) <= 2665
        ]
        ...
        for token in (
            ...
            "integration_binding_count == 41",
            "public_check_count == 246",
        ...
        self.assertIn("kmfa_v015_s18_stage_review:", model)
        self.assertIn("kmfa_v015_s18_stage_review:", metadata_model)
    ...
    def test_project_mirrors_name_pending_review(self) -> None:
        for relative in (
            ...
            for token in (
                ...
                "s18_stage_review_performed: false",
                "s19_p1_entry_allowed: false",
    ...
    def test_traceability_version_and_assurance(self) -> None:
        governance = builder.PROJECT_ROOT / "docs/governance"
        self.assertIn(
            "REQ-KMFA-V015-S18-STAGE-REVIEW",
        ...
        self.assertIn(f'kmfa_v015_s18_stage_review: "{builder.VERSION}"', version)
        assurance = (governance / "ASSURANCE_STATUS.yaml").read_text(encoding="utf-8")
        self.assertIn("total_active_parameters: 2280", assurance)
        self.assertIn("total_active_formulas: 388", assurance)
