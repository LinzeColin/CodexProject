...
class S17StageReviewContractTests(unittest.TestCase):
    ...
    def test_public_verification_has_exact_accounting(self) -> None:
        ...
        self.assertEqual(
            value["accounting"], {"total": 253, "passed": 253, "failed": 0}
        )
        self.assertEqual(value["failed_checks"], [])

    def test_all_four_fix_markers_are_bound_to_live_code(self) -> None:
        roots = (
    ...
    def test_technical_audit_has_no_open_issue(self) -> None:
        ...
        self.assertEqual(
            ...
            {"money_consistency", "scope_isolation", "reversibility", "report_honesty", "human_usability"},
        )
