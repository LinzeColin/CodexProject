...
class SourceAdapterGovernanceTests(unittest.TestCase):
    ...
    def test_no_raw_external_or_release_action_in_public_evidence(self) -> None:
        manifest = json.loads(builder.MANIFEST_PATH.read_text(encoding="utf-8"))
        ...
        self.assertFalse(manifest["automatic_login_performed"])
