#!/usr/bin/env python3
"""严格检查 KMFA v1.5 S21 整体复审及正式验收绑定。"""
...
EXPECTED_VALIDATIONS = (
    ("phase_contract", "PYTHONDONTWRITEBYTECODE=1 PYTHONPATH=. python3 -B KMFA/tools/v015_s21_stage_review_contract.py"),
    ("focused_contract_tests", "PYTHONDONTWRITEBYTECODE=1 PYTHONPATH=. python3 -B -m unittest KMFA.tests.test_v015_s21_stage_review_contract"),
    ("focused_review_tests", "PYTHONDONTWRITEBYTECODE=1 PYTHONPATH=. python3 -B -m unittest KMFA.tests.test_v015_s21_stage_review"),
    ("focused_browser_tests", "PYTHONDONTWRITEBYTECODE=1 PYTHONPATH=. python3 -B KMFA/tools/run_v015_s21_stage_review_browser_tests.py"),
    ("focused_artifact_tests", "PYTHONDONTWRITEBYTECODE=1 PYTHONPATH=. python3 -B -m unittest KMFA.tests.test_v015_s21_stage_review_artifacts"),
    ("focused_governance_tests", "PYTHONDONTWRITEBYTECODE=1 PYTHONPATH=. python3 -B -m unittest KMFA.tests.test_v015_s21_stage_review_governance"),
    ("s21_p1_dependency", "PYTHONDONTWRITEBYTECODE=1 PYTHONPATH=. python3 -B KMFA/tools/v015_s21_p1_report_model.py"),
    ("s21_p2_dependency", "PYTHONDONTWRITEBYTECODE=1 PYTHONPATH=. python3 -B KMFA/tools/v015_s21_p2_report_generation.py"),
    ("s21_p3_dependency", "PYTHONDONTWRITEBYTECODE=1 PYTHONPATH=. python3 -B KMFA/tools/v015_s21_p3_report_workflow.py"),
    ("s21_p1_kernel_regression", "PYTHONDONTWRITEBYTECODE=1 PYTHONPATH=. python3 -B -m unittest KMFA.tests.test_v015_s21_p1_report_model"),
    ("s21_p2_kernel_regression", "PYTHONDONTWRITEBYTECODE=1 PYTHONPATH=. python3 -B -m unittest KMFA.tests.test_v015_s21_p2_report_generation"),
    ("s21_p3_kernel_regression", "PYTHONDONTWRITEBYTECODE=1 PYTHONPATH=. python3 -B -m unittest KMFA.tests.test_v015_s21_p3_report_workflow"),
    ("s21_p1_runtime_regression", "PYTHONDONTWRITEBYTECODE=1 PYTHONPATH=. python3 -B -m unittest KMFA.tests.test_v015_s21_p1_report_model_runtime"),
    ("s21_p2_runtime_regression", "PYTHONDONTWRITEBYTECODE=1 PYTHONPATH=. python3 -B -m unittest KMFA.tests.test_v015_s21_p2_report_generation_runtime"),
    ("s21_p3_runtime_regression", "PYTHONDONTWRITEBYTECODE=1 PYTHONPATH=. python3 -B -m unittest KMFA.tests.test_v015_s21_p3_report_workflow_runtime"),
    ("s21_p1_browser_regression", "PYTHONDONTWRITEBYTECODE=1 PYTHONPATH=. python3 -B KMFA/tools/run_v015_s21_p1_browser_tests.py"),
    ("s21_p2_browser_regression", "PYTHONDONTWRITEBYTECODE=1 PYTHONPATH=. python3 -B KMFA/tools/run_v015_s21_p2_browser_tests.py"),
    ("s21_p3_browser_regression", "PYTHONDONTWRITEBYTECODE=1 PYTHONPATH=. python3 -B KMFA/tools/run_v015_s21_p3_browser_tests.py"),
    ("integrated_review_consistency", "PYTHONDONTWRITEBYTECODE=1 PYTHONPATH=. python3 -B KMFA/tools/check_v015_s21_stage_review.py --integrated-review-check"),
    ("builder_exact_rebuild", "PYTHONDONTWRITEBYTECODE=1 PYTHONPATH=. python3 -B KMFA/tools/build_v015_s21_stage_review.py --check"),
    ("stage_checker_pre_final", "PYTHONDONTWRITEBYTECODE=1 PYTHONPATH=. python3 -B KMFA/tools/check_v015_s21_stage_review.py --pre-final --skip-validation-receipts --skip-clean-commit"),
    ...
    ("roadmap_sync_pending", "PYTHONDONTWRITEBYTECODE=1 PYTHONPATH=. python3 -B KMFA/tools/v015_roadmap_governance_sync.py --check --validation-state S21_STAGE_REVIEW_PENDING_FINAL_VALIDATION"),
    ...
    ("governance_sync", "PYTHONDONTWRITEBYTECODE=1 PYTHONPATH=. python3 -B KMFA/tools/check_v015_s21_stage_review.py --clean-governance-sync-check"),
    ...
    ("taskpack_source", "PYTHONDONTWRITEBYTECODE=1 PYTHONPATH=. python3 -B KMFA/tools/check_v015_s21_stage_review.py --taskpack-source-check"),
    ("public_boundary", "PYTHONDONTWRITEBYTECODE=1 PYTHONPATH=. python3 -B KMFA/tools/check_v015_s21_stage_review.py --public-boundary-check"),
...
ALLOWED_PREFIXES = (
    ...
    "KMFA/metadata/stage_status.jsonl", "KMFA/stage_artifacts/V015_S21_STAGE_REVIEW/",
    "KMFA/tests/test_v015_roadmap_governance_sync.py",
    "KMFA/tests/test_v015_s21_stage_review.py", "KMFA/tests/test_v015_s21_stage_review_artifacts.py",
    "KMFA/tests/test_v015_s21_stage_review_browser.py", "KMFA/tests/test_v015_s21_stage_review_contract.py",
    "KMFA/tests/test_v015_s21_stage_review_governance.py",
    "KMFA/tools/build_v015_s21_stage_review.py", "KMFA/tools/check_v015_s21_stage_review.py",
    "KMFA/tools/run_v015_s21_p1_report_model.py", "KMFA/tools/run_v015_s21_p2_report_generation.py",
    "KMFA/tools/run_v015_s21_p3_report_workflow.py", "KMFA/tools/run_v015_s21_stage_review_browser_tests.py",
    "KMFA/tools/run_v015_s21_stage_review_validations.py", "KMFA/tools/v015_roadmap_governance_sync.py",
    "KMFA/tools/v015_s21_stage_review_contract.py", "KMFA/功能清单.md", "KMFA/开发记录.md", "KMFA/模型参数文件.md",
)
...
def _check_scope() -> None:
    if subprocess.run(["git", "merge-base", "--is-ancestor", builder.REVIEW_BASE_COMMIT, "HEAD"], cwd=REPO_ROOT, check=False).returncode:
        raise CheckError("S21 review base is not an ancestor of HEAD")
    changed: set[str] = set()
    for args in (
...
def _check_taskpack_source() -> None:
    ...
    if source.get("stage_id") != "S21" or source.get("phase_ids") != ["S21-P1", "S21-P2", "S21-P3"] or source.get("source_integrity_status") != "PASS":
        raise CheckError("tracked S21 source contract drift")
...
def _check_public_boundary() -> None:
    ...
    roots = (builder.OUTPUT_ROOT, REPO_ROOT / "KMFA/tools/v015_s21_stage_review_contract.py")
    for root in roots:
...
def _check_evidence(*, require_receipts: bool) -> None:
    ...
    if require_receipts and manifest.get("stage_acceptance_status") != "PASSED":
        raise CheckError("S21 stage review is not passed")
    if not require_receipts and manifest.get("stage_acceptance_status") not in {"PENDING", "PASSED"}:
        raise CheckError("S21 stage review pending manifest is invalid")
    ...
    if integrated.get("integration_binding_count") != 44 or integrated.get("integration_binding_failed_count") != 0 or not integrated.get("stage_acceptance_ready"):
        raise CheckError("integrated review failed")
    if verification.get("public_check_count") != 44 or verification.get("public_check_failed_count") != 0:
    ...
    if len(findings) != 3 or any(row.get("status") != "FIXED_VALIDATED" or row.get("blocks_stage_acceptance") != "false" for row in findings):
    ...
    if state == "PENDING" and manifest.get("s22_entry_allowed"):
        raise CheckError("S22 opened before formal validation")
    if manifest.get("s22_p1_started") or manifest.get("github_upload_performed") or manifest.get("app_reinstall_performed"):
