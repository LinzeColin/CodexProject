#!/usr/bin/env python3
"""严格检查 KMFA v1.5 S20 整体复审及正式验收绑定。"""
...
EXPECTED_VALIDATIONS = (
    ("phase_contract", "PYTHONDONTWRITEBYTECODE=1 PYTHONPATH=. python3 -B KMFA/tools/v015_s20_stage_review_contract.py"),
    ("focused_contract_tests", "PYTHONDONTWRITEBYTECODE=1 PYTHONPATH=. python3 -B -m unittest KMFA.tests.test_v015_s20_stage_review_contract"),
    ("focused_review_tests", "PYTHONDONTWRITEBYTECODE=1 PYTHONPATH=. python3 -B -m unittest KMFA.tests.test_v015_s20_stage_review"),
    ("focused_browser_tests", "PYTHONDONTWRITEBYTECODE=1 PYTHONPATH=. python3 -B KMFA/tools/run_v015_s20_stage_review_browser_tests.py"),
    ("focused_artifact_tests", "PYTHONDONTWRITEBYTECODE=1 PYTHONPATH=. python3 -B -m unittest KMFA.tests.test_v015_s20_stage_review_evidence KMFA.tests.test_v015_s20_stage_review_artifacts"),
    ("focused_governance_tests", "PYTHONDONTWRITEBYTECODE=1 PYTHONPATH=. python3 -B -m unittest KMFA.tests.test_v015_s20_stage_review_governance"),
    ("s20_p1_dependency", "PYTHONDONTWRITEBYTECODE=1 PYTHONPATH=. python3 -B KMFA/tools/v015_s20_p1_data_update.py"),
    ("s20_p2_dependency", "PYTHONDONTWRITEBYTECODE=1 PYTHONPATH=. python3 -B KMFA/tools/v015_s20_p2_confirmation_workbench.py"),
    ("s20_p3_dependency", "PYTHONDONTWRITEBYTECODE=1 PYTHONPATH=. python3 -B KMFA/tools/v015_s20_p3_recalculation_publication.py"),
    ("s20_p1_kernel_regression", "PYTHONDONTWRITEBYTECODE=1 PYTHONPATH=. python3 -B -m unittest KMFA.tests.test_v015_s20_p1_data_update"),
    ("s20_p2_kernel_regression", "PYTHONDONTWRITEBYTECODE=1 PYTHONPATH=. python3 -B -m unittest KMFA.tests.test_v015_s20_p2_confirmation_workbench"),
    ("s20_p3_kernel_regression", "PYTHONDONTWRITEBYTECODE=1 PYTHONPATH=. python3 -B -m unittest KMFA.tests.test_v015_s20_p3_recalculation_publication"),
    ("s20_p1_runtime_regression", "PYTHONDONTWRITEBYTECODE=1 PYTHONPATH=. python3 -B -m unittest KMFA.tests.test_v015_s20_p1_data_update_runtime"),
    ("s20_p2_runtime_regression", "PYTHONDONTWRITEBYTECODE=1 PYTHONPATH=. python3 -B -m unittest KMFA.tests.test_v015_s20_p2_confirmation_workbench_runtime"),
    ("s20_p3_runtime_regression", "PYTHONDONTWRITEBYTECODE=1 PYTHONPATH=. python3 -B -m unittest KMFA.tests.test_v015_s20_p3_recalculation_publication_runtime"),
    ("s20_p1_browser_regression", "PYTHONDONTWRITEBYTECODE=1 PYTHONPATH=. python3 -B KMFA/tools/run_v015_s20_p1_browser_tests.py"),
    ("s20_p2_browser_regression", "PYTHONDONTWRITEBYTECODE=1 PYTHONPATH=. python3 -B KMFA/tools/run_v015_s20_p2_browser_tests.py"),
    ("s20_p3_browser_regression", "PYTHONDONTWRITEBYTECODE=1 PYTHONPATH=. python3 -B KMFA/tools/run_v015_s20_p3_browser_tests.py"),
    ("integrated_review_consistency", "PYTHONDONTWRITEBYTECODE=1 PYTHONPATH=. python3 -B KMFA/tools/check_v015_s20_stage_review.py --integrated-review-check"),
    ("builder_exact_rebuild", "PYTHONDONTWRITEBYTECODE=1 PYTHONPATH=. python3 -B KMFA/tools/build_v015_s20_stage_review.py --check"),
    ("stage_checker_pre_final", "PYTHONDONTWRITEBYTECODE=1 PYTHONPATH=. python3 -B KMFA/tools/check_v015_s20_stage_review.py --pre-final --skip-validation-receipts --skip-clean-commit"),
    ...
    ("roadmap_sync_pending", "PYTHONDONTWRITEBYTECODE=1 PYTHONPATH=. python3 -B KMFA/tools/v015_roadmap_governance_sync.py --check --validation-state S20_STAGE_REVIEW_PENDING_FINAL_VALIDATION"),
    ...
    ("governance_sync", "PYTHONDONTWRITEBYTECODE=1 PYTHONPATH=. python3 -B KMFA/tools/check_v015_s20_stage_review.py --clean-governance-sync-check"),
    ...
    ("taskpack_source", "PYTHONDONTWRITEBYTECODE=1 PYTHONPATH=. python3 -B KMFA/tools/check_v015_s20_stage_review.py --taskpack-source-check"),
    ("public_boundary", "PYTHONDONTWRITEBYTECODE=1 PYTHONPATH=. python3 -B KMFA/tools/check_v015_s20_stage_review.py --public-boundary-check"),
...
ALLOWED_PREFIXES = (
    ...
    "KMFA/stage_artifacts/V015_S20_P1_DATA_UPDATE/",
    "KMFA/stage_artifacts/V015_S20_P2_CONFIRMATION_WORKBENCH/",
    "KMFA/stage_artifacts/V015_S20_P3_RECALCULATION_PUBLICATION/",
    "KMFA/stage_artifacts/V015_S20_STAGE_REVIEW/",
    ...
    "KMFA/tests/test_v015_s20_stage_review.py",
    "KMFA/tests/test_v015_s20_stage_review_evidence.py",
    "KMFA/tests/test_v015_s20_stage_review_artifacts.py",
    "KMFA/tests/test_v015_s20_stage_review_browser.py",
    "KMFA/tests/test_v015_s20_stage_review_contract.py",
    "KMFA/tests/test_v015_s20_stage_review_governance.py",
    "KMFA/tools/build_v015_s20_stage_review.py",
    "KMFA/tools/check_v015_s20_stage_review.py",
    "KMFA/tools/run_v015_s20_p1_data_update.py",
    "KMFA/tools/run_v015_s20_p2_confirmation_workbench.py",
    "KMFA/tools/run_v015_s20_p3_browser_tests.py",
    "KMFA/tools/run_v015_s20_p3_recalculation_publication.py",
    "KMFA/tools/run_v015_s20_stage_review_browser_tests.py",
    "KMFA/tools/run_v015_s20_stage_review_validations.py",
    "KMFA/tools/v015_roadmap_governance_sync.py",
    "KMFA/tools/v015_s20_p3_recalculation_publication.py",
    "KMFA/tools/v015_s20_stage_review_contract.py",
    "KMFA/功能清单.md",
    "KMFA/开发记录.md",
    "KMFA/模型参数文件.md",
)
...
FINAL_MUTABLE_PATHS = frozenset(
    {
        ...
        "KMFA/metadata/project/project.yaml",
        "KMFA/metadata/stage_status.jsonl",
        "KMFA/stage_artifacts/V015_S20_STAGE_REVIEW/human/stage20_review_report_zh.md",
        "KMFA/stage_artifacts/V015_S20_STAGE_REVIEW/human/test_results_zh.md",
        "KMFA/stage_artifacts/V015_S20_STAGE_REVIEW/machine/s20_stage_review_manifest.json",
        "KMFA/stage_artifacts/V015_S20_STAGE_REVIEW/machine/validation_results.jsonl",
        "KMFA/功能清单.md",
        "KMFA/开发记录.md",
        "KMFA/模型参数文件.md",
    }
...
def _check_scope() -> None:
    ...
    if result.returncode:
        raise CheckError("S20 review base is not an ancestor of HEAD")
    changed: set[str] = set()
    for args in (
...
def _check_taskpack_source() -> None:
    ...
    if (
        source.get("stage_id") != "S20"
        or source.get("phase_ids") != ["S20-P1", "S20-P2", "S20-P3"]
        or source.get("source_integrity_status") != "PASS"
    ):
        raise CheckError("tracked S20 source contract drift")
...
def _check_public_boundary() -> None:
    ...
    roots = (builder.OUTPUT_ROOT, builder.PROJECT_ROOT / "tools/v015_s20_stage_review_contract.py")
    for root in roots:
...
def _check_integrated_review() -> None:
    ...
    if verification.get("accounting") != {"total": 239, "passed": 239, "failed": 0}:
    ...
    if summary["technical_audit_score"] != 20 or summary["open_review_finding_count"] != 0:
...
def _check_manifest(*, pre_final: bool) -> dict[str, Any]:
    ...
    required = {
        ...
        "decision": "REMAIN_IN_S20_STAGE_REVIEW" if pre_final else "GO_TO_S21_P1_ONLY",
        "overall_accepted_phase_count": 58,
        "overall_taskpack_phase_count": 72,
        "s20_stage_review_started": True,
        "s20_stage_review_performed": not pre_final,
        "s21_entry_allowed": not pre_final,
        "s21_p1_entry_allowed": not pre_final,
...
def main() -> int:
    parser = argparse.ArgumentParser(description="检查 KMFA v1.5 S20 整体复审")
