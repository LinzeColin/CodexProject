#!/usr/bin/env python3
"""Run one exact validation receipt set for KMFA v1.5 S06-P1."""
...
from KMFA.tools import check_v015_s06_p1_authoritative_source_registration as checker
...
def run() -> list[dict[str, Any]]:
    ...
    if (
        ...
        or subject.get("stage_acceptance_status") != "PENDING"
        or subject.get("s06_p2_entry_allowed") is not False
    ):
        raise ValidationError("validation subject must be pending S06-P1 with S06-P2 closed")
    ...
    for name, command in checker.EXPECTED_VALIDATIONS:
        ...
        receipt = {
            "schema_version": "kmfa.v015.s06p1.validation_receipt.v1",
...
def main() -> int:
    try:
        ...
        return 1
    print(
        "PASS: S06-P1 validation receipts "
