...
- Natural language explanation: Operational deterministic lookup for threshold, motion, visual, refresh, calibration, frontend hydration guard, gold-quality gate and operator-input release blocker visibility parameters without a scoring formula.
