...
- 2026-06-23 T1307/A209 watchdog adds operational defaults `interval_seconds=300` and `stale_after_seconds=900` for background soak monitoring/recovery; no governed model parameter, scoring model, graph traversal formula, extraction formula, formula weight or runtime threshold changed.
