...
1. 24h operator soak evidence (background run PID `12478`, checkpoint heartbeat `61/288` PASS at `2026-06-23T15:47:26Z`; detached watchdog PID `62233` is running; monitor/supervisor/watchdog/heartbeat and clean-room package evidence are not release-ready closure)
