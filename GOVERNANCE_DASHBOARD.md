...
- source_snapshot_hash: `sha256:5aa48085bf440686ac59805806176530e62d91dc2fb9d19c62283b45e1184f14`
...
| `arxiv-daily-push` | `0.13.0` | `S1-A` | `VERIFIED` | `VERIFIED` | `UNVERIFIED` | `PARTIAL` | `PARTIAL` | `PARTIAL` | `FAILED` | `ADP-PHASE11-PRODUCTION-TRIAL-START-022` |
