...
| `EEI` | `0.1.0` | MOD-001:business-empire-model-v2, MOD-002:business-empire-model-v2, +10 | balanced-v2:2, default-v2:2, +1 | `planned` | `ITER-20260621-015` | `D` | `TASK-T1307-A209-RUNNER-REPAIR-REMOTE-CI` | `EVENT-20260621-017` | No scoring formula change; remote CI evidence only. | No canonical parameter behavior change; remote CI evidence only. | A209 remains open until committed 4h and 24h operator soak evidence exists. | 14 | `required` | `TASK-T1307` |
| `EVA_OS` | `0.1.0` | MOD-001:0.0.0-provisional, MOD-002:0.0.0-provisional, +14 | default:param-profile-20260620 | `planned` | `ITER-20260620-EVA-002` | `A` | `GOV-P13-required-passed` | `ITER-20260620-EVA-002` | UNKNOWN | UNKNOWN | calibration/source rationale gaps tracked by `TASK-EVA-B-001` through `TASK-EVA-B-008` | 2 | `required` | `TASK-EVA-B-003` |
...
| `PFI_BIG_DATA_SIMULATOR` | `0.1.0` | MOD-001:0.0.0-provisional, MOD-002:0.0.0-provisional, +13 | default:param-profile-20260620 | `planned` | `ITER-20260620-PFI-002` | `A` | `GOV-P13-required-passed` | `ITER-20260620-PFI-002` | UNKNOWN | UNKNOWN | calibration/source rationale gaps tracked by `TASK-PFI-B-001` through `TASK-PFI-B-010` | 2 | `required` | `TASK-PFI-B-001` |
...
| `whkmSalary` | `0.0.0` | MOD-001:salary-logic-v0, MOD-002:streamlit-input-v0 | province_weights:salary-logic-v0, salary_logic_constants:salary-logic-v0, +1 | `planned` | `ITER-20260620-WHKM-001` | `E` | `GOV-G4-WHKM-REQUIRED` | `EVENT-WHKM-20260620-002` | UNKNOWN | UNKNOWN | `TASK-WHKM-B-001` for policy/source/effective date/rounding/boundary evidence. | 2 | `required` | `TASK-WHKM-B-001` |
