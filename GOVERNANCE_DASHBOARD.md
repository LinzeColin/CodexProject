...
- source_snapshot_hash: `sha256:ec7cdf6ee6199fc706ad3a97222006c9bdb8d3f33a5e67ebf63e4d8c8c061669`
...
| `arxiv-daily-push` | `0.15.0` | `S1-A` | `VERIFIED` | `VERIFIED` | `UNVERIFIED` | `PARTIAL` | `PARTIAL` | `PARTIAL` | `FAILED` | `ADP-PHASE11-PRODUCTION-TRIAL-START-022` |
